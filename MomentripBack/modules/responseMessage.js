module.exports = {
  ...
  FOLLOW_USER_SUCCESS : "사용자  팔로우 성공",
  FOLLOW_USER_FAIL : "사용자 팔로우 실패",
  UNFOLLOW_USER_SUCCESS : "사용자 언팔로우 성공",
  UNFOLLOW_USER_FAIL : "사용자 언팔로우 실패",
  COUNT_FOLLOW_SUCCESS : "사용자 팔로우 팔로워 수 세기 성공",
  COUNT_FOLLOW_FAIL : "사용자 팔로우 팔로워 수 세기 실패",
  FIND_USER_FOLLOW_SUCCESS : "유저 팔로우 목록 불러오기 성공",
  FIND_USER_FOLLOW_FAIL : "유저 팔로우 목록 불러오기 실패",
